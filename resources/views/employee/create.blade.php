<x-layout>
    ...
    <div class="bg-white/10 mt-16 rounded-xs relative sm:hidden">
        ...
        <form action="/employees/create" method="POST" class="flex flex-col text-left mx-auto w-9/10">
            @csrf
            <h1 class="py-8 text-2xl font-bold">Add a New Employee</h1>
            ...
            <div class="w-full mt-10">
                <button type="submit" class="my-8 border border-white/15 w-full p-3 rounded-xs bg-white/10 hover:bg-white/15 ml-auto mr-2">Add Employee</button>
            </div>
        </form>
    </div>
    ...
    <div class="hidden sm:block bg-gray-800 mt-25 rounded-xs relative w-lg mx-auto">
        ...
        <form action="/employees/create" method="POST" class="text-left mx-auto w-md">
            ...
            <div class="flex flex-col px-2">
                <label for="first_name" class="font-bold">First Name<span class="text-red-500 ml-2">*</span></label>
                <input type="text" id="first_name" name="first_name" class="bg-white/15 mt-2 rounded-xs p-3">
                <x-errors name="first_name" />
            </div>

            <div class="flex flex-col px-2">
                <label for="last_name" class="mt-6 font-bold">Last Name<span class="text-red-500 ml-2">*</span></label>
                <input type="text" id="last_name" name="last_name" class="bg-white/15 mt-2 rounded-xs p-3">
                <x-errors name="last_name" />
            </div>
            ...
            <div class="flex flex-col px-2">
                ...
                <input type="text" id="personal_email" name="personal_email" class="bg-white/15 mt-2 rounded-xs p-3">
                <x-errors name="personal_email" />
            </div>

            <div class="flex flex-col px-2">
                <label for="phone" class="mt-6 font-bold">Phone<span class="text-red-500 ml-2">*</span></label>
                <input type="text" id="phone" name="phone" class="bg-white/15 mt-2 rounded-xs p-3">
                <x-errors name="phone" />
            </div>
